...
public:
  ...
  /**
    ...
    */
    ...
    std::vector<std::string> ingredients_; // a vector of ingredients 
    int prep_time_; //preparation time for food
    double price_; //price of dish
    CuisineType cuisine_type_; //cusiine type of dish
};
